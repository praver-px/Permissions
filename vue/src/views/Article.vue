<template>
  <div>
    ...
    <el-table
      ...
      <el-table-column prop="content" show-overflow-tooltip align="center" label="文章内容">
        <template slot-scope="scope">
          <el-button circle @click="view(scope.row.content)" type="primary"><i class="el-icon-view"></i></el-button>
        </template>
      </el-table-column>
      ...
      <el-table-column label="操作" width="280" align="center">
        <template slot-scope="scope">
          <el-button type="success" circle @click="handleEdit(scope.row)" v-if="user.role === 'ROLE_ADMIN'"><i
          ...
          >
            <el-button type="danger" circle slot="reference" v-if="user.role === 'ROLE_ADMIN'"><i
...
export default {
  ...
  methods: {
    ...
    imgAdd(pos, $file) {
      ...
      axios({
        url: 'http://localhost:9090/api/file/upload',
        method: 'post',
        data: formData,
    ...
    load() {
      this.request.get("/article/page", {params: this.params}).then(res => {
